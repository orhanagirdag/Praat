...
const API_KEY = process.env.API1 || process.env.OPENAI_API_KEY;

if (!API_KEY) {
  console.warn('⚠️  Geen OpenAI-sleutel gevonden. Voeg deze toe aan je .env (bijv. OPENAI_API_KEY=...) of stel de API1-variabele in.');
}
